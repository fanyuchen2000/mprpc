...
extern PROTOBUF_INTERNAL_EXPORT_firend_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_firend_2eproto;
namespace fixbug {
...
static void InitDefaultsscc_info_GetFriendsListRequest_firend_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendsListRequest_firend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendsListRequest_firend_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendsListResponse_firend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendsListResponse_firend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendsListResponse_firend_2eproto}, {
      &scc_info_ResultCode_firend_2eproto.base,}};

static void InitDefaultsscc_info_ResultCode_firend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_firend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ResultCode_firend_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_firend_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_firend_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_firend_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_firend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_firend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014firend.proto\022\006fixbug\"-\n\nResultCode\022\017\n\007"
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_firend_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_firend_2eproto_sccs[3] = {
  &scc_info_GetFriendsListRequest_firend_2eproto.base,
  &scc_info_GetFriendsListResponse_firend_2eproto.base,
  &scc_info_ResultCode_firend_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_firend_2eproto_once;
static bool descriptor_table_firend_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_firend_2eproto = {
  &descriptor_table_firend_2eproto_initialized, descriptor_table_protodef_firend_2eproto, "firend.proto", 303,
  &descriptor_table_firend_2eproto_once, descriptor_table_firend_2eproto_sccs, descriptor_table_firend_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_firend_2eproto::offsets,
  file_level_metadata_firend_2eproto, 3, file_level_enum_descriptors_firend_2eproto, file_level_service_descriptors_firend_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_firend_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_firend_2eproto), true);
namespace fixbug {
...
void ResultCode::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResultCode_firend_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  errcode_ = 0;
}
...
const GetFriendsListRequest& GetFriendsListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendsListRequest_firend_2eproto.base);
  return *internal_default_instance();
}
...
void GetFriendsListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendsListResponse_firend_2eproto.base);
  result_ = nullptr;
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServiceRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_firend_2eproto);
  return file_level_service_descriptors_firend_2eproto[0];
}
...
void FriendServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_firend_2eproto[0]);
  switch(method->index()) {
    case 0:
