...
template<> ::fixbug::Res* Arena::CreateMaybeMessage<::fixbug::Res>(Arena*);
...
class Res :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.Res) */ {
 public:
  Res();
  virtual ~Res();
  ...
  inline Res* New() const final {
    return CreateMaybeMessage<Res>(nullptr);
  }

  Res* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:fixbug.Res)
 private:
  class _Internal;
...
class LoginResponse :
 ...
 public:
  ...
  public:
  void clear_result();
  const ::fixbug::Res& result() const;
  ::fixbug::Res* release_result();
  ::fixbug::Res* mutable_result();
  void set_allocated_result(::fixbug::Res* result);
  private:
  const ::fixbug::Res& _internal_result() const;
  ::fixbug::Res* _internal_mutable_result();
  public:
...
// int32 errcode = 1;
inline void Res::clear_errcode() {
  errcode_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Res::_internal_errcode() const {
  return errcode_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Res::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.Res.errcode)
  return _internal_errcode();
}
inline void Res::_internal_set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errcode_ = value;
}
inline void Res::set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_errcode(value);
  // @@protoc_insertion_point(field_set:fixbug.Res.errcode)
}

// bytes errmsg = 2;
inline void Res::clear_errmsg() {
  errmsg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Res::errmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.Res.errmsg)
  return _internal_errmsg();
}
inline void Res::set_errmsg(const std::string& value) {
  _internal_set_errmsg(value);
  // @@protoc_insertion_point(field_set:fixbug.Res.errmsg)
}
inline std::string* Res::mutable_errmsg() {
  // @@protoc_insertion_point(field_mutable:fixbug.Res.errmsg)
  return _internal_mutable_errmsg();
}
inline const std::string& Res::_internal_errmsg() const {
  return errmsg_.GetNoArena();
}
inline void Res::_internal_set_errmsg(const std::string& value) {
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Res::set_errmsg(std::string&& value) {
  
  errmsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.Res.errmsg)
}
inline void Res::set_errmsg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.Res.errmsg)
}
inline void Res::set_errmsg(const void* value, size_t size) {
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.Res.errmsg)
}
inline std::string* Res::_internal_mutable_errmsg() {
  
  return errmsg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Res::release_errmsg() {
  // @@protoc_insertion_point(field_release:fixbug.Res.errmsg)
  
  return errmsg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Res::set_allocated_errmsg(std::string* errmsg) {
  if (errmsg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.Res.errmsg)
}
...
inline const ::fixbug::Res& LoginResponse::_internal_result() const {
  const ::fixbug::Res* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::Res*>(
      &::fixbug::_Res_default_instance_);
}
inline const ::fixbug::Res& LoginResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.result)
  return _internal_result();
}
inline ::fixbug::Res* LoginResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.result)
  
  ::fixbug::Res* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::Res* LoginResponse::_internal_mutable_result() {
  
  if (result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::Res>(GetArenaNoVirtual());
    result_ = p;
  }
  return result_;
}
inline ::fixbug::Res* LoginResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.result)
  return _internal_mutable_result();
}
inline void LoginResponse::set_allocated_result(::fixbug::Res* result) {
...
inline const ::fixbug::Res& GetFriendListResponse::_internal_result() const {
  const ::fixbug::Res* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::Res*>(
      &::fixbug::_Res_default_instance_);
}
inline const ::fixbug::Res& GetFriendListResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.result)
  return _internal_result();
}
inline ::fixbug::Res* GetFriendListResponse::release_result() {
...
inline ::fixbug::Res* GetFriendListResponse::_internal_mutable_result() {
...
inline ::fixbug::Res* GetFriendListResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.result)
  return _internal_mutable_result();
}
inline void GetFriendListResponse::set_allocated_result(::fixbug::Res* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
