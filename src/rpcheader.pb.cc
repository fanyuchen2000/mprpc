...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, serviec_name_),
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\014serviec_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001(\014"
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  serviec_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_serviec_name().empty()) {
    serviec_name_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.serviec_name_);
  }
...
void RpcHeader::SharedDtor() {
  serviec_name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_serviec_name();
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  // bytes serviec_name = 1;
  if (this->serviec_name().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        1, this->_internal_serviec_name(), target);
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  serviec_name_.Swap(&other->serviec_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
