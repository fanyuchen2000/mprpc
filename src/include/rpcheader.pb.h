...
class RpcHeader :
 ...
 public:
  ...
  enum : int {
    kServiecNameFieldNumber = 1,
    kMethodNameFieldNumber = 2,
    kArgsSizeFieldNumber = 3,
  };
  // bytes serviec_name = 1;
  void clear_serviec_name();
  const std::string& serviec_name() const;
  void set_serviec_name(const std::string& value);
  void set_serviec_name(std::string&& value);
  void set_serviec_name(const char* value);
  void set_serviec_name(const void* value, size_t size);
  std::string* mutable_serviec_name();
  std::string* release_serviec_name();
  void set_allocated_serviec_name(std::string* serviec_name);
  private:
  const std::string& _internal_serviec_name() const;
  void _internal_set_serviec_name(const std::string& value);
  std::string* _internal_mutable_serviec_name();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr serviec_name_;
...
// bytes serviec_name = 1;
inline void RpcHeader::clear_serviec_name() {
  serviec_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RpcHeader::serviec_name() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.serviec_name)
  return _internal_serviec_name();
}
inline void RpcHeader::set_serviec_name(const std::string& value) {
  _internal_set_serviec_name(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.serviec_name)
}
inline std::string* RpcHeader::mutable_serviec_name() {
  // @@protoc_insertion_point(field_mutable:mprpc.RpcHeader.serviec_name)
  return _internal_mutable_serviec_name();
}
inline const std::string& RpcHeader::_internal_serviec_name() const {
  return serviec_name_.GetNoArena();
}
inline void RpcHeader::_internal_set_serviec_name(const std::string& value) {
  
  serviec_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RpcHeader::set_serviec_name(std::string&& value) {
  
  serviec_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpc.RpcHeader.serviec_name)
}
inline void RpcHeader::set_serviec_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  serviec_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpc.RpcHeader.serviec_name)
}
inline void RpcHeader::set_serviec_name(const void* value, size_t size) {
  
  serviec_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpc.RpcHeader.serviec_name)
}
inline std::string* RpcHeader::_internal_mutable_serviec_name() {
  
  return serviec_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RpcHeader::release_serviec_name() {
  // @@protoc_insertion_point(field_release:mprpc.RpcHeader.serviec_name)
  
  return serviec_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RpcHeader::set_allocated_serviec_name(std::string* serviec_name) {
  if (serviec_name != nullptr) {
    
  } else {
    
  }
  serviec_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serviec_name);
  // @@protoc_insertion_point(field_set_allocated:mprpc.RpcHeader.serviec_name)
}
